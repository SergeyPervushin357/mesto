...
### 📃Краткое описание:
- *Одностраничный сайт. Структура сайта реализована с помощью* **HTML5, Grid Layout and Flex**. *Интерфейс адаптрирован для разных разрешений. Как* **PC** так и **MOBILE** version. На сайте реализованна логика открытия модальных окон редактирования данных с помощью языка **ООП JavaScript**. Сайт Deployed in Server.*
