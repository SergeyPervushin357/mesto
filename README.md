...
### 📃Краткое описание:
- Одностраничный сайт. Структура сайта реализована с помощью  Grid Layout and  Flex Адаптированный интерфейс для разных разрешений. Как PC так и MOBILE version. На сайте реализованна логика открытия модальных окон редактирования данных с помощью языка  JavaScript. Сайт Deployed in Server.
